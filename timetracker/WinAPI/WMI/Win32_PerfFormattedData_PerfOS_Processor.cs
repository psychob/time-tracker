...
namespace timetracker.WinAPI.WMI
{
	class Win32_PerfFormattedData_PerfOS_Processor : Win32_PerfFormattedData
	{
		...
		public const string ClassName = "Win32_PerfFormattedData_PerfOS_Processor";

		public const string Namespace = @"\\.\root\CIMV2";

		public Win32_PerfFormattedData_PerfOS_Processor(ManagementBaseObject mbo) : base(mbo)
		{
		...
		public static List<Win32_PerfFormattedData_PerfOS_Processor> Fetch()
		{
			return FetchImpl(Namespace, ClassName,
				p => new Win32_PerfFormattedData_PerfOS_Processor(p));
		}

		public static ManagementEventWatcher Watch(int Interval,
			WatchType Type, Action<Win32_PerfFormattedData_PerfOS_Processor> onEvent)
		{
