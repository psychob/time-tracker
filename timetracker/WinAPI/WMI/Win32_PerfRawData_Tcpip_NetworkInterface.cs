...
namespace timetracker.WinAPI.WMI
{
	class Win32_PerfRawData_Tcpip_NetworkInterface : Win32_PerfRawData
	{
		...
		public const string ClassName = "Win32_PerfRawData_Tcpip_NetworkInterface";

		public const string Namespace = @"\\.\root\CIMV2";

		public Win32_PerfRawData_Tcpip_NetworkInterface(ManagementBaseObject mbo) : base(mbo)
		{
		...
		public static List<Win32_PerfRawData_Tcpip_NetworkInterface> Fetch()
		{
			return FetchImpl(Namespace, ClassName,
				p => new Win32_PerfRawData_Tcpip_NetworkInterface(p));
		}

		public static ManagementEventWatcher Watch(int Interval,
			WatchType Type, Action<Win32_PerfRawData_Tcpip_NetworkInterface> onEvent)
		{
			return WatchImpl(Interval, Namespace, ClassName,
				Type, onEvent, p => new Win32_PerfRawData_Tcpip_NetworkInterface(p));
		}
	}
}
